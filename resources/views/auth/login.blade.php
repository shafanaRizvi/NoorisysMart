    ...
    <div class="auth-wrapper">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                <h2 class="title">{{translate('Welcome')}} <span class="d-block">{{translate('back to your')}}</span> <strong class="text--039D55">{{translate('Ecommerce')}}</strong><br><strong class="text--039D55">{{translate('Admin Panel')}}....</strong></h2>
            </div>
        </div>
